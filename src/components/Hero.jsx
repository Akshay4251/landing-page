    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <div
          ...
          bg-purple-950/10 dark:bg-black
          bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.15),rgba(255,255,255,0))]
          dark:bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(0,0,0,0))]"
        />

        <section className="relative max-w-full mx-auto z-10">
          {/* Grid Effect - behind everything */}
          ...
          <div className="max-w-screen-xl z-20 mx-auto px-4 py-28 gap-12 md:px-8">
            ...
            <div className="space-y-5 max-w-3xl mx-auto text-center">
              ...
              <h2
                className="text-4xl tracking-tighter font-geist bg-clip-text text-transparent mx-auto md:text-6xl 
                  ...
                  <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-white dark:bg-gray-950 text-xs font-medium backdrop-blur-3xl">
                    <a
                      ...
                      className="inline-flex rounded-full text-center group items-center w-full justify-center 
                        ...
                        text-gray-900 dark:text-white border-[1px] border-input
          ...
          <div className="mt-10 flex justify-center z-30 relative">
            <img
              ...
              className="rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-7xl w-full"
            />
          </div>
        </section>
      </div>
